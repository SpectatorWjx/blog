...
<head>
    ...
    <!-- Favicons -->
    <link href="<@resource src='/dist/images/logo/m.png'/>" rel="apple-touch-icon-precomposed" />
    <link href="<@resource src='/dist/images/logo/m.png'/>" rel="shortcut icon" />
</head>
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="${base}/index" class="logo">
            ...
            <span class="logo-lg"><b>旁观者</b></span>
        </a>
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li><a href="https://delpast.com" title="跳转到前台" target="_blank"><i class="fa fa-television"></i></a></li>
