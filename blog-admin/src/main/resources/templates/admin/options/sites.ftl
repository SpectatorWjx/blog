<form id="qForm" class="form-horizontal" method="post" action="update">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="site_domain" class="form-control" value="${options['site_domain']}" placeholder="示例: https://blogad.delpast.com">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="site_banner" class="form-control" value="${options['site_banner']}" placeholder="请输入banner图地址">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Banner</label>
