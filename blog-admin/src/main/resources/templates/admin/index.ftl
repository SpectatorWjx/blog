    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="${base}/admin/link/list" class="small-box-footer">更多 <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
    </div>
        ...
        J.getJSON('${base}/api/latest_comments', function (result) {
            if (result.length > 0) {
                ...
                J.each(result, function (i, n) {
                    var row = J.format(template, n.author.avatar, n.author.id, n.createTime, n.author.name, n.content);
                    html.push(row);
                })
                $('#chat-box').html(html);
            }
