...
import com.wang.blog.shiro.AccountRealm;
import com.wang.blog.shiro.AccountSubjectFactory;
import com.wang.blog.shiro.AuthenticatedFilter;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        shiroFilter.setUnauthorizedUrl("/reject");
        ...
        hashMap.put("/admin/link/list", "authc,perms[link:list]");
        hashMap.put("/admin/link/update", "authc,perms[link:update]");
        hashMap.put("/admin/link/deleteBatch", "authc,perms[link:delete]");

        hashMap.put("/admin/theme/*", "authc,perms[theme:index]");

        hashMap.put("/admin", "authc,perms[blog]");
        hashMap.put("/admin/*", "authc,perms[blog]");
