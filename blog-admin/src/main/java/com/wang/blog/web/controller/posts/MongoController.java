package com.wang.blog.web.controller.posts;
...
public class MongoController {
    ...
    @ResponseBody
    public Object serveImageOnline(@PathVariable String id) {
        return mongoService.serveImageOnline(id, false);
    }
    ...
    @ResponseBody
    public Object serveOriginalImageOnline(@PathVariable String id) {
        return mongoService.serveImageOnline(id, true);
    }
    ...
    public Result formUpload(MultipartFile file){
        ImageVo imageVo = mongoService.saveFile(file,0.5);
